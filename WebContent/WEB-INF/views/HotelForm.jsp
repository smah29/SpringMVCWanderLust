...
<form:form id="form1" action="./SearchHotelByPlace" modelAttribute="hotel">





<form:label path="hotelLocation">Place</form:label>
	<form:select path="hotelLocation">
		<form:option value="hotelLocation">Select Place</form:option>
